...
import {
  initBillsComponents,
  BillsModule,
} from "@egovernments/digit-ui-module-bills";
...
/**
 * Same contextPath resolver as in App.js – URL first, then global, then default.
 */
...
const initDigitUI = () => {
  // IMPORTANT: contextPath is now URL-aware
